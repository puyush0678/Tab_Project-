...
function App() {
  ...
  function handleSelectProject(id) {
    setProjectsState((prevState) => {
      return {
        ...
        projectTask: prevState.tasks.filter((task) => task.projectId === id),
      };
    });
  }
  ...
  function handleAddTask(text) {
    setProjectsState((prevState) => {
      ...
      return {
        ...
        projectTask: [newTask, ...prevState.projectTask],
      };
    });
  }
  function handleDeleteTask(id) {
    setProjectsState((prevState) => {
      return {
        ...
        projectTask: prevState.tasks.filter(
          (task) =>
            task.projectId == prevState.selectedProjectId && task.id !== id,
        ),
      };
    });
  }
  ...
  let content = (
    <SelectedProject
      ...
      tasks={projectsState.projectTask}
    />
  );
